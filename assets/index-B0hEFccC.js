 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $O="firebase-heartbeat-database",zO=1,du="firebase-heartbeat-store";let Rp=null;function qR(){return Rp||(Rp=rO($O,zO,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(du)}catch(n){console.warn(n)}}}}).catch(t=>{throw Tn.create("idb-open",{originalErrorMessage:t.message})})),Rp}async function qO(t){try{const n=(await qR()).transaction(du),r=await n.objectStore(du).get(WR(t));return await n.done,r}catch(e){if(e instanceof Ct)xr.warn(e.message);else{const n=Tn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});xr.warn(n.message)}}}async function bE(t,e){try{const r=(await qR()).transaction(du,"readwrite");await r.objectStore(du).put(e,WR(t)),await r.done}catch(n){if(n instanceof Ct)xr.warn(n.message);else{const r=Tn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});xr.warn(r.message)}}}function WR(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YO(t){Nr(new An("platform-logger",e=>new oO(e),"PRIVATE")),Nr(new An("heartbeat",e=>new KO(e),"PRIVATE")),hn(Yd,Bm,t),hn(Yd,Bm,"esm2017"),hn("fire-js","")}YO("");const JO=Object.freeze(Object.defineProperty({__proto__:null,FirebaseError:Ct,SDK_VERSION:Fr,_DEFAULT_ENTRY_NAME:Si,_addComponent:cu,_addOrOverwriteComponent:UR,_apps:Ri,_clearComponents:MO,_components:ea,_getProvider:Ta,_isFirebaseApp:jR,_isFirebaseServerApp:qe,_registerComponent:Nr,_removeServiceInstance:LO,_serverApps:Zo,deleteApp:x_,getApp:Uh,getApps:BO,initializeApp:b_,initializeServerApp:jO,onLog:$R,registerVersion:hn,setLogLevel:zR},Symbol.toStringTag,{value:"Module"}));var DE=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ai=new Fh("@firebase/firestore");function fo(){return Ai.logLevel}function XO(t){Ai.setLogLevel(t)}function B(t,...e){if(Ai.logLevel<=ie.DEBUG){const n=e.map(N_);Ai.debug(`Firestore (${Sa}): ${t}`,...n)}}function Ye(t,...e){if(Ai.logLevel<=ie.ERROR){const n=e.map(N_);Ai.error(`Firestore (${Sa}): ${t}`,...n)}}function rr(t,...e){if(Ai.logLevel<=ie.WARN){const n=e.map(N_);Ai.warn(`Firestore (${Sa}): ${t}`,...n)}}function N_(t){if(typeof t=="string")return t;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qV{constructor(e,n=null,r=[],i=[],s=null,o=null,a=null){this.path=e,this.collectionGroup=n,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=o,this.endAt=a,this.ue=null}}function Qm(t,e=null,n=[],r=[],i=null,s=null,o=null){return new qV(t,e,n,r,i,s,o)}function xs(t){const e=K(t);if(e.ue===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(r=>Hm(r)).join(","),n+="|ob:",n+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),Vu(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>na(r)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>na(r)).join(",")),e.ue=n}return e.ue}function Lu(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!MV(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!yA(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!KE(t.startAt,e.startAt)&&KE(t.endAt,e.endAt)}function Xd(t){return G.isDocumentKey(t.path)&&t.collectionGroup===null&&t.filters.length===0}function Zd(t,e){return t.filters.filter(n=>n instanceof ae&&n.field.isEqual(e))}function HE(t,e,n){let r=dd,i=!0;for(const s of Zd(t,e)){let o=dd,a=!0;switch(s.op){case"<":case"<=":o=VV(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,a=!1;break;case"!=":case"not-in":o=dd}qE({value:r,inclusive:i},{value:o,inclusive:a})<0&&(r=o,i=a)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];qE({value:r,inclusive:i},{value:o,inclusive:n.inclusive})<0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}function QE(t,e,n){let r=ci,i=!0;for(const s of Zd(t,e)){let o=ci,a=!0;switch(s.op){case">=":case">":o=LV(s.value),a=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,a=!1;break;case"!=":case"not-in":o=ci}WE({value:r,inclusive:i},{value:o,inclusive:a})>0&&(r=o,i=a)}if(n!==null){for(let s=0;s<t.orderBy.length;++s)if(t.orderBy[s].field.isEqual(e)){const o=n.position[s];WE({value:r,inclusive:i},{value:o,inclusive:n.inclusive})>0&&(r=o,i=n.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qF(){return new Wu("deleteField")}function WF(){return new wy("serverTimestamp")}function GF(...t){return new Ey("arrayUnion",t)}function KF(...t){return new Iy("arrayRemove",t)}function HF(t){return new Ty("increment",t)}(function(e,n=!0){(function(i){Sa=i})(Fr),Nr(new An("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new Xe(new nV(r.getProvider("auth-internal")),new oV(r.getProvider("app-check-internal")),function(c,d){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new j(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ki(c.options.projectId,d)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),hn(OE,"4.7.3",e),hn(OE,"4.7.3","esm2017")})();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JF(t){const e={},n={__esModule:!0,initializeApp:s,app:i,registerVersion:hn,setLogLevel:zR,onLog:$R,apps:null,SDK_VERSION:Fr,INTERNAL:{registerComponent:a,removeApp:r,useAsService:l,modularAPIs:JO}};n.default=n,Object.defineProperty(n,"apps",{get:o});function r(c){delete e[c]}function i(c){if(c=c||Si,!RE(e,c))throw WI.create("no-app",{appName:c});return e[c]}i.App=t;function s(c,d={}){const f=b_(c,d);if(RE(e,f.name))return e[f.name];const m=new t(f,n);return e[f.name]=m,m}function o(){return Object.keys(e).map(c=>e[c])}function a(c){const d=c.name,f=d.replace("-compat","");if(Nr(c)&&c.type==="PUBLIC"){const m=(_=i())=>{if(typeof _[f]!="function")throw WI.create("invalid-app-argument",{appName:d});return _[f]()};c.serviceProps!==void 0&&Qd(m,c.serviceProps),n[f]=m,t.prototype[f]=function(..._){return this._getService.bind(this,d).apply(this,c.multipleInstances?_:[])}}return c.type==="PUBLIC"?n[f]:null}function l(c,d){return d==="serverAuth"?null:d}return n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ch=new Fh("@firebase/auth");function a2(t,...e){ch.logLevel<=ie.WARN&&ch.warn(`Auth (${Fr}): ${t}`,...e)}function gd(t,...e){ch.logLevel<=ie.ERROR&&ch.error(`Auth (${Fr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vr(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Ct&&w2(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function w2({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ck(t,e=[]){let n;switch(t){case"Browser":n=XI(Ue());break;case"Worker":n=`${XI(Ue())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Fr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function H2(t,e){return $r(t,"POST","/v1/accounts:signInWithPassword",Ke(t,e))}async function cf(t,e){return He(t,"POST","/v1/accounts:sendOobCode",Ke(t,e))}async function Q2(t,e){return cf(t,e)}async function Y2(t,e){return cf(t,e)}async function J2(t,e){return cf(t,e)}async function X2(t,e){return cf(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z2(t,e){return $r(t,"POST","/v1/accounts:signInWithEmailLink",Ke(t,e))}async function eU(t,e){return $r(t,"POST","/v1/accounts:signInWithEmailLink",Ke(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sr(t,e){return $r(t,"POST","/v1/accounts:signInWithIdp",Ke(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nU(t,e){return He(t,"POST","/v1/accounts:sendVerificationCode",Ke(t,e))}async function rU(t,e){return $r(t,"POST","/v1/accounts:signInWithPhoneNumber",Ke(t,e))}async function iU(t,e){const n=await $r(t,"POST","/v1/accounts:signInWithPhoneNumber",Ke(t,e));if(n.temporaryProof)throw Rl(t,"account-exists-with-different-credential",n);return n}const sU={USER_NOT_FOUND:"user-not-found"};async function oU(t,e){const n=Object.assign(Object.assign({},e),{operation:"REAUTH"});return $r(t,"POST","/v1/accounts:signInWithPhoneNumber",Ke(t,n),sU)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ok(t,e){return $r(t,"POST","/v1/accounts:signUp",Ke(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mk(t,e,n=!1){const{auth:r}=t;if(qe(r.app))return Promise.reject(dt(r));const i="reauthenticate";try{const s=await Vr(t,Vk(r,i,e,t),n);z(s.idToken,r,"internal-error");const o=uf(s.idToken);z(o,r,"internal-error");const{sub:a}=o;return z(t.uid===a,r,"user-mismatch"),Pn._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&ht(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fU(t,e){return $r(t,"POST","/v1/accounts:signInWithCustomToken",Ke(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PU(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=Y(t),s={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await Vr(r,AU(r.auth,s));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const a=r.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=r.displayName,a.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function kU(t,e){const n=Y(t);return qe(n.auth.app)?Promise.reject(dt(n.auth)):qk(n,e,null)}function CU(t,e){return qk(Y(t),null,e)}async function qk(t,e,n){const{auth:r}=t,s={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(s.email=e),n&&(s.password=n);const o=await Vr(t,W2(r,s));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mB(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function gB(t){Nr(new An("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;z(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ck(t)},c=new D2(r,i,s,l);return $2(c,n),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Nr(new An("auth-internal",e=>{const n=Ge(e.getProvider("auth").getImmediate());return(r=>new pB(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),hn(lT,uT,mB(t)),hn(lT,uT,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",_=mr.getBlob(f,r,m);if(_===null)throw RC();const S={name:c.fullPath},P=zi(s,t.host,t._protocol),x="POST",E=t.maxUploadRetryTime,v=new qr(P,x,Tf(t,n),E);return v.urlParams=S,v.headers=o,v.body=_.uploadData(),v.errorHandler=Va(e),v}class mh{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function sv(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{nr(!1)}return nr(!!n&&(e||["active"]).indexOf(n)!==-1),n}function g$(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=MC(e,r,i),a={name:o.fullPath},l=zi(s,t.host,t._protocol),c="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=iv(o,n),m=t.maxUploadRetryTime;function _(P){sv(P);let x;try{x=P.getResponseHeader("X-Goog-Upload-URL")}catch{nr(!1)}return nr(Ef(x)),x}const S=new qr(l,c,_,m);return S.urlParams=a,S.headers=d,S.body=f,S.errorHandler=Va(e),S}function _$(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const d=sv(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{nr(!1)}f||nr(!1);const m=Number(f);return nr(!isNaN(m)),new mh(m,r.size(),d==="final")}const o="POST",a=t.maxUploadRetryTime,l=new qr(n,o,s,a);return l.headers=i,l.errorHandler=Va(e),l}const vT=256*1024;function y$(t,e,n,r,i,s,o,a){const l=new mh(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw b4();const c=l.total-l.current;let d=c;i>0&&(d=Math.min(d,i));const f=l.current,m=f+d;let _="";d===0?_="finalize":c===d?_="upload, finalize":_="upload";const S={"X-Goog-Upload-Command":_,"X-Goog-Upload-Offset":`${l.current}`},P=r.slice(f,m);if(P===null)throw RC();function x(b,F){const U=sv(b,["active","final"]),w=l.current+d,y=r.size();let T;return U==="final"?T=Tf(e,s)(b,F):T=null,new mh(w,y,U==="final",T)}const E="POST",v=e.maxUploadRetryTime,I=new qr(n,E,x,v);return I.headers=S,I.body=P.uploadData(),I.progressCallback=a||null,I.errorHandler=Va(t),I}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GC{constructor(e,n){this.app=e,this._delegate=n}get maxOperationRetryTime(){return this._delegate.maxOperationRetryTime}get maxUploadRetryTime(){return this._delegate.maxUploadRetryTime}ref(e){if(RT(e))throw qo("ref() expected a child path but got a URL, use refFromURL instead.");return new Rr(Tg(this._delegate,e),this)}refFromURL(e){if(!RT(e))throw qo("refFromURL() expected a full URL but got a child path, use ref() instead.");try{kt.makeFromUrl(e,this._delegate.host)}catch{throw qo("refFromUrl() expected a valid full URL but got an invalid one.")}return new Rr(Tg(this._delegate,e),this)}setMaxUploadRetryTime(e){this._delegate.maxUploadRetryTime=e}setMaxOperationRetryTime(e){this._delegate.maxOperationRetryTime=e}useEmulator(e,n,r={}){WC(this._delegate,e,n,r)}}function RT(t){return/^[A-Za-z]+:\/\//.test(t)}const z$="@firebase/storage-compat",q$="0.3.12";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
