...
*/var ws,GR;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,g){function S(){}S.prototype=g.prototype,E.D=g.prototype,E.prototype=new S,E.prototype.constructor=E,E.C=function(A,k,N){for(var P=Array(arguments.length-2),mt=2;mt<arguments.length;mt++)P[mt-2]=arguments[mt];return g.prototype[k].apply(A,P)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,g,S){S||(S=0);var A=Array(16);if(typeof g=="string")for(var k=0;16>k;++k)A[k]=g.charCodeAt(S++)|g.charCodeAt(S++)<<8|g.charCodeAt(S++)<<16|g.charCodeAt(S++)<<24;else for(k=0;16>k;++k)A[k]=g[S++]|g[S++]<<8|g[S++]<<16|g[S++]<<24;g=E.g[0],S=E.g[1],k=E.g[2];var N=E.g[3],P=g+(N^S&(k^N))+A[0]+3614090360&4294967295;g=S+(P<<7&4294967295|P>>>25),P=N+(k^g&(S^k))+A[1]+3905402710&4294967295,N=g+(P<<12&4294967295|P>>>20),P=k+(S^N&(g^S))+A[2]+606105819&4294967295,k=N+(P<<17&4294967295|P>>>15),P=S+(g^k&(N^g))+A[3]+3250441966&4294967295,S=k+(P<<22&4294967295|P>>>10),P=g+(N^S&(k^N))+A[4]+4118548399&4294967295,g=S+(P<<7&4294967295|P>>>25),P=N+(k^g&(S^k))+A[5]+1200080426&4294967295,N=g+(P<<12&4294967295|P>>>20),P=k+(S^N&(g^S))+A[6]+2821735955&4294967295,k=N+(P<<17&4294967295|P>>>15),P=S+(g^k&(N^g))+A[7]+4249261313&4294967295,S=k+(P<<22&4294967295|P>>>10),P=g+(N^S&(k^N))+A[8]+1770035416&4294967295,g=S+(P<<7&4294967295|P>>>25),P=N+(k^g&(S^k))+A[9]+2336552879&4294967295,N=g+(P<<12&4294967295|P>>>20),P=k+(S^N&(g^S))+A[10]+4294925233&4294967295,k=N+(P<<17&4294967295|P>>>15),P=S+(g^k&(N^g))+A[11]+2304563134&4294967295,S=k+(P<<22&4294967295|P>>>10),P=g+(N^S&(k^N))+A[12]+1804603682&4294967295,g=S+(P<<7&4294967295|P>>>25),P=N+(k^g&(S^k))+A[13]+4254626195&4294967295,N=g+(P<<12&4294967295|P>>>20),P=k+(S^N&(g^S))+A[14]+2792965006&4294967295,k=N+(P<<17&4294967295|P>>>15),P=S+(g^k&(N^g))+A[15]+1236535329&4294967295,S=k+(P<<22&4294967295|P>>>10),P=g+(k^N&(S^k))+A[1]+4129170786&4294967295,g=S+(P<<5&4294967295|P>>>27),P=N+(S^k&(g^S))+A[6]+3225465664&4294967295,N=g+(P<<9&4294967295|P>>>23),P=k+(g^S&(N^g))+A[11]+643717713&4294967295,k=N+(P<<14&4294967295|P>>>18),P=S+(N^g&(k^N))+A[0]+3921069994&4294967295,S=k+(P<<20&4294967295|P>>>12),P=g+(k^N&(S^k))+A[5]+3593408605&4294967295,g=S+(P<<5&4294967295|P>>>27),P=N+(S^k&(g^S))+A[10]+38016083&4294967295,N=g+(P<<9&4294967295|P>>>23),P=k+(g^S&(N^g))+A[15]+3634488961&4294967295,k=N+(P<<14&4294967295|P>>>18),P=S+(N^g&(k^N))+A[4]+3889429448&4294967295,S=k+(P<<20&4294967295|P>>>12),P=g+(k^N&(S^k))+A[9]+568446438&4294967295,g=S+(P<<5&4294967295|P>>>27),P=N+(S^k&(g^S))+A[14]+3275163606&4294967295,N=g+(P<<9&4294967295|P>>>23),P=k+(g^S&(N^g))+A[3]+4107603335&4294967295,k=N+(P<<14&4294967295|P>>>18),P=S+(N^g&(k^N))+A[8]+1163531501&4294967295,S=k+(P<<20&4294967295|P>>>12),P=g+(k^N&(S^k))+A[13]+2850285829&4294967295,g=S+(P<<5&4294967295|P>>>27),P=N+(S^k&(g^S))+A[2]+4243563512&4294967295,N=g+(P<<9&4294967295|P>>>23),P=k+(g^S&(N^g))+A[7]+1735328473&4294967295,k=N+(P<<14&4294967295|P>>>18),P=S+(N^g&(k^N))+A[12]+2368359562&4294967295,S=k+(P<<20&4294967295|P>>>12),P=g+(S^k^N)+A[5]+4294588738&4294967295,g=S+(P<<4&4294967295|P>>>28),P=N+(g^S^k)+A[8]+2272392833&4294967295,N=g+(P<<11&4294967295|P>>>21),P=k+(N^g^S)+A[11]+1839030562&4294967295,k=N+(P<<16&4294967295|P>>>16),P=S+(k^N^g)+A[14]+4259657740&4294967295,S=k+(P<<23&4294967295|P>>>9),P=g+(S^k^N)+A[1]+2763975236&4294967295,g=S+(P<<4&4294967295|P>>>28),P=N+(g^S^k)+A[4]+1272893353&4294967295,N=g+(P<<11&4294967295|P>>>21),P=k+(N^g^S)+A[7]+4139469664&4294967295,k=N+(P<<16&4294967295|P>>>16),P=S+(k^N^g)+A[10]+3200236656&4294967295,S=k+(P<<23&4294967295|P>>>9),P=g+(S^k^N)+A[13]+681279174&4294967295,g=S+(P<<4&4294967295|P>>>28),P=N+(g^S^k)+A[0]+3936430074&4294967295,N=g+(P<<11&4294967295|P>>>21),P=k+(N^g^S)+A[3]+3572445317&4294967295,k=N+(P<<16&4294967295|P>>>16),P=S+(k^N^g)+A[6]+76029189&4294967295,S=k+(P<<23&4294967295|P>>>9),P=g+(S^k^N)+A[9]+3654602809&4294967295,g=S+(P<<4&4294967295|P>>>28),P=N+(g^S^k)+A[12]+3873151461&4294967295,N=g+(P<<11&4294967295|P>>>21),P=k+(N^g^S)+A[15]+530742520&4294967295,k=N+(P<<16&4294967295|P>>>16),P=S+(k^N^g)+A[2]+3299628645&4294967295,S=k+(P<<23&4294967295|P>>>9),P=g+(k^(S|~N))+A[0]+4096336452&4294967295,g=S+(P<<6&4294967295|P>>>26),P=N+(S^(g|~k))+A[7]+1126891415&4294967295,N=g+(P<<10&4294967295|P>>>22),P=k+(g^(N|~S))+A[14]+2878612391&4294967295,k=N+(P<<15&4294967295|P>>>17),P=S+(N^(k|~g))+A[5]+4237533241&4294967295,S=k+(P<<21&4294967295|P>>>11),P=g+(k^(S|~N))+A[12]+1700485571&4294967295,g=S+(P<<6&4294967295|P>>>26),P=N+(S^(g|~k))+A[3]+2399980690&4294967295,N=g+(P<<10&4294967295|P>>>22),P=k+(g^(N|~S))+A[10]+4293915773&4294967295,k=N+(P<<15&4294967295|P>>>17),P=S+(N^(k|~g))+A[1]+2240044497&4294967295,S=k+(P<<21&4294967295|P>>>11),P=g+(k^(S|~N))+A[8]+1873313359&4294967295,g=S+(P<<6&4294967295|P>>>26),P=N+(S^(g|~k))+A[15]+4264355552&4294967295,N=g+(P<<10&4294967295|P>>>22),P=k+(g^(N|~S))+A[6]+2734768916&4294967295,k=N+(P<<15&4294967295|P>>>17),P=S+(N^(k|~g))+A[13]+1309151649&4294967295,S=k+(P<<21&4294967295|P>>>11),P=g+(k^(S|~N))+A[4]+4149444226&4294967295,g=S+(P<<6&4294967295|P>>>26),P=N+(S^(g|~k))+A[11]+3174756917&4294967295,N=g+(P<<10&4294967295|P>>>22),P=k+(g^(N|~S))+A[2]+718787259&4294967295,k=N+(P<<15&4294967295|P>>>17),P=S+(N^(k|~g))+A[9]+3951481745&4294967295,E.g[0]=E.g[0]+g&4294967295,E.g[1]=E.g[1]+(k+(P<<21&4294967295|P>>>11))&4294967295,E.g[2]=E.g[2]+k&4294967295,E.g[3]=E.g[3]+N&4294967295}r.prototype.u=function(E,g){g===void 0&&(g=E.length);for(var S=g-this.blockSize,A=this.B,k=this.h,N=0;N<g;){if(k==0)for(;N<=S;)i(this,E,N),N+=this.blockSize;if(typeof E=="string"){for(;N<g;)if(A[k++]=E.charCodeAt(N++),k==this.blockSize){i(this,A),k=0;break}}else for(;N<g;)if(A[k++]=E[N++],k==this.blockSize){i(this,A),k=0;break}}this.h=k,this.o+=g},r.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var g=1;g<E.length-8;++g)E[g]=0;var S=8*this.o;for(g=E.length-8;g<E.length;++g)E[g]=S&255,S/=256;for(this.u(E),E=Array(16),g=S=0;4>g;++g)for(var A=0;32>A;A+=8)E[S++]=this.g[g]>>>A&255;return E};function s(E,g){var S=a;return Object.prototype.hasOwnProperty.call(S,E)?S[E]:S[E]=g(E)}function o(E,g){this.h=g;for(var S=[],A=!0,k=E.length-1;0<=k;k--){var N=E[k]|0;A&&N==g||(S[k]=N,A=!1)}this.g=S}var a={};function l(E){return-128<=E&&128>E?s(E,function(g){return new o([g|0],0>g?-1:0)}):new o([E|0],0>E?-1:0)}function c(E){if(isNaN(E)||!isFinite(E))return f;if(0>E)return x(c(-E));for(var g=[],S=1,A=0;E>=S;A++)g[A]=E/S|0,S*=4294967296;return new o(g,0)}function d(E,g){if(E.length==0)throw Error("number format error: empty string");if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(E.charAt(0)=="-")return x(d(E.substring(1),g));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=c(Math.pow(g,8)),A=f,k=0;k<E.length;k+=8){var N=Math.min(8,E.length-k),P=parseInt(E.substring(k,k+N),g);8>N?(N=c(Math.pow(g,N)),A=A.j(N).add(c(P))):(A=A.j(S),A=A.add(c(P)))}return A}var f=l(0),m=l(1),y=l(16777216);t=o.prototype,t.m=function(){if(C(this))return-x(this).m();for(var E=0,g=1,S=0;S<this.g.length;S++){var A=this.i(S);E+=(0<=A?A:4294967296+A)*g,g*=4294967296}return E},t.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(R(this))return"0";if(C(this))return"-"+x(this).toString(E);for(var g=c(Math.pow(E,6)),S=this,A="";;){var k=b(S,g).g;S=I(S,k.j(g));var N=((0<S.g.length?S.g[0]:S.h)>>>0).toString(E);if(S=k,R(S))return N+A;for(;6>N.length;)N="0"+N;A=N+A}},t.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function R(E){if(E.h!=0)return!1;for(var g=0;g<E.g.length;g++)if(E.g[g]!=0)return!1;return!0}function C(E){return E.h==-1}t.l=function(E){return E=I(this,E),C(E)?-1:R(E)?0:1};function x(E){for(var g=E.g.length,S=[],A=0;A<g;A++)S[A]=~E.g[A];return new o(S,~E.h).add(m)}t.abs=function(){return C(this)?x(this):this},t.add=function(E){for(var g=Math.max(this.g.length,E.g.length),S=[],A=0,k=0;k<=g;k++){var N=A+(this.i(k)&65535)+(E.i(k)&65535),P=(N>>>16)+(this.i(k)>>>16)+(E.i(k)>>>16);A=P>>>16,N&=65535,P&=65535,S[k]=P<<16|N}return new o(S,S[S.length-1]&-2147483648?-1:0)};function I(E,g){return E.add(x(g))}t.j=function(E){if(R(this)||R(E))return f;if(C(this))return C(E)?x(this).j(x(E)):x(x(this).j(E));if(C(E))return x(this.j(x(E)));if(0>this.l(y)&&0>E.l(y))return c(this.m()*E.m());for(var g=this.g.length+E.g.length,S=[],A=0;A<2*g;A++)S[A]=0;for(A=0;A<this.g.length;A++)for(var k=0;k<E.g.length;k++){var N=this.i(A)>>>16,P=this.i(A)&65535,mt=E.i(k)>>>16,bn=E.i(k)&65535;S[2*A+2*k]+=P*bn,w(S,2*A+2*k),S[2*A+2*k+1]+=N*bn,w(S,2*A+2*k+1),S[2*A+2*k+1]+=P*mt,w(S,2*A+2*k+1),S[2*A+2*k+2]+=N*mt,w(S,2*A+2*k+2)}for(A=0;A<g;A++)S[A]=S[2*A+1]<<16|S[2*A];for(A=g;A<2*g;A++)S[A]=0;return new o(S,0)};function w(E,g){for(;(E[g]&65535)!=E[g];)E[g+1]+=E[g]>>>16,E[g]&=65535,g++}function T(E,g){this.g=E,this.h=g}function b(E,g){if(R(g))throw Error("division by zero");if(R(E))return new T(f,f);if(C(E))return g=b(x(E),g),new T(x(g.g),x(g.h));if(C(g))return g=b(E,x(g)),new T(x(g.g),g.h);if(30<E.g.length){if(C(E)||C(g))throw Error("slowDivide_ only works with positive integers.");for(var S=m,A=g;0>=A.l(E);)S=F(S),A=F(A);var k=U(S,1),N=U(A,1);for(A=U(A,2),S=U(S,2);!R(A);){var P=N.add(A);0>=P.l(E)&&(k=k.add(S),N=P),A=U(A,1),S=U(S,1)}return g=I(E,k.j(g)),new T(k,g)}for(k=f;0<=E.l(g);){for(S=Math.max(1,Math.floor(E.m()/g.m())),A=Math.ceil(Math.log(S)/Math.LN2),A=48>=A?1:Math.pow(2,A-48),N=c(S),P=N.j(g);C(P)||0<P.l(E);)S-=A,N=c(S),P=N.j(g);R(N)&&(N=m),k=k.add(N),E=I(E,P)}return new T(k,E)}t.A=function(E){return b(this,E).h},t.and=function(E){for(var g=Math.max(this.g.length,E.g.length),S=[],A=0;A<g;A++)S[A]=this.i(A)&E.i(A);return new o(S,this.h&E.h)},t.or=function(E){for(var g=Math.max(this.g.length,E.g.length),S=[],A=0;A<g;A++)S[A]=this.i(A)|E.i(A);return new o(S,this.h|E.h)},t.xor=function(E){for(var g=Math.max(this.g.length,E.g.length),S=[],A=0;A<g;A++)S[A]=this.i(A)^E.i(A);return new o(S,this.h^E.h)};function F(E){for(var g=E.g.length+1,S=[],A=0;A<g;A++)S[A]=E.i(A)<<1|E.i(A-1)>>>31;return new o(S,E.h)}function U(E,g){var S=g>>5;g%=32;for(var A=E.g.length-S,k=[],N=0;N<A;N++)k[N]=0<g?E.i(N+S)>>>g|E.i(N+S+1)<<32-g:E.i(N+S);return new o(k,E.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,GR=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,ws=o}).apply(typeof DE<"u"?DE:typeof self<"u"?self:typeof window<"u"?window:{});var Uc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=xt.makeFromUrl(e,n)}catch{return new xt(e,"")}if(r.path==="")return r;throw P4(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(b){b.path.charAt(b.path.length-1)==="/"&&(b.path_=b.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(b){b.path_=decodeURIComponent(b.path)}const d="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",y=new RegExp(`^https?://${f}/${d}/b/${i}/o${m}`,"i"),R={bucket:1,path:3},C=n===Ek?"(?:storage.googleapis.com|storage.cloud.google.com)":n,x="([^?#]*)",I=new RegExp(`^https?://${C}/${i}/${x}`,"i"),T=[{regex:a,indices:l,postModify:s},{regex:y,indices:R,postModify:c},{regex:I,indices:{bucket:1,path:2},postModify:c}];for(let b=0;b<T.length;b++){const F=T[b],U=F.regex.exec(e);if(U){const E=U[F.indices.bucket];let g=U[F.indices.path];g||(g=""),r=new xt(E,g),F.postModify(r);break}}if(r==null)throw A4(e);return r}}class N4{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D4(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function d(...x){c||(c=!0,e.apply(null,x))}function f(x){i=setTimeout(()=>{i=null,t(y,l())},x)}function m(){s&&clearTimeout(s)}function y(x,...I){if(c){m();return}if(x){m(),d.call(null,x,...I);return}if(l()||o){m(),d.call(null,x,...I);return}r<64&&(r*=2);let T;a===1?(a=2,T=0):T=(r+Math.random())*1e3,f(T)}let R=!1;function C(x){R||(R=!0,m(),!c&&(i!==null?(x||(a=2),clearTimeout(i),f(0)):x||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,C(!0)},n),C}function O4(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",y=gr.getBlob(f,r,m);if(y===null)throw Rk();const R={name:c.fullPath},C=qi(s,t.host,t._protocol),x="POST",I=t.maxUploadRetryTime,w=new Gr(C,x,Tf(t,n),I);return w.urlParams=R,w.headers=o,w.body=y.uploadData(),w.errorHandler=Va(e),w}class mh{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function sv(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{ir(!1)}return ir(!!n&&(e||["active"]).indexOf(n)!==-1),n}function m$(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=Mk(e,r,i),a={name:o.fullPath},l=qi(s,t.host,t._protocol),c="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=iv(o,n),m=t.maxUploadRetryTime;function y(C){sv(C);let x;try{x=C.getResponseHeader("X-Goog-Upload-URL")}catch{ir(!1)}return ir(Ef(x)),x}const R=new Gr(l,c,y,m);return R.urlParams=a,R.headers=d,R.body=f,R.errorHandler=Va(e),R}function g$(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const d=sv(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{ir(!1)}f||ir(!1);const m=Number(f);return ir(!isNaN(m)),new mh(m,r.size(),d==="final")}const o="POST",a=t.maxUploadRetryTime,l=new Gr(n,o,s,a);return l.headers=i,l.errorHandler=Va(e),l}const vT=256*1024;function _$(t,e,n,r,i,s,o,a){const l=new mh(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw k4();const c=l.total-l.current;let d=c;i>0&&(d=Math.min(d,i));const f=l.current,m=f+d;let y="";d===0?y="finalize":c===d?y="upload, finalize":y="upload";const R={"X-Goog-Upload-Command":y,"X-Goog-Upload-Offset":`${l.current}`},C=r.slice(f,m);if(C===null)throw Rk();function x(b,F){const U=sv(b,["active","final"]),E=l.current+d,g=r.size();let S;return U==="final"?S=Tf(e,s)(b,F):S=null,new mh(E,g,U==="final",S)}const I="POST",w=e.maxUploadRetryTime,T=new Gr(n,I,x,w);return T.headers=R,T.body=C.uploadData(),T.progressCallback=a||null,T.errorHandler=Va(t),T}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
